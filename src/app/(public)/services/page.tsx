  ...
  return (
    <div className="container mx-auto py-20 px-6">
      <div className="mb-12 max-w-2xl">
        ...
        <p className="text-muted-foreground text-lg font-light">Бесплатные инструменты для диагностики сети и доменов без ограничений.</p>
      </div>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Link href="/services/dig" className="group">
          <div className="rounded-2xl border border-border bg-card p-6 h-full group-hover:bg-muted/80 group-hover:border-foreground/20 transition-all">
        ...
        <Link href="/services/audit" className="group">
          <div className="rounded-2xl border border-border bg-card p-6 h-full group-hover:bg-muted/80 group-hover:border-foreground/20 transition-all">
            <div className="h-10 w-10 rounded-full bg-muted flex items-center justify-center mb-6">
              <SearchCode className="h-5 w-5 text-foreground" />
            </div>
